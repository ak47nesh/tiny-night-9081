...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-night-9081
```

A live public deployment of this template is available at [https://tiny-night-9081.templates.workers.dev](https://tiny-night-9081.templates.workers.dev)
